...
ORG 04h
 ...
 isr:
    btfsc ((INTCON) and 07Fh), 0 ;interrupcion de los botones
    call int_ioc ;llamamos la interrupcion de los botones

    btfsc ((PIR1) and 07Fh), 0 ;interrupcion del timer 1
    call fue_tmr1 ;llamamos a la interrupcion del timer1

    btfsc ((INTCON) and 07Fh), 2 ;interrupcion timer0
