...
SETUP:
    ...
    BCF TRISA, 0 ;ponemos el puerto ((PORTA) and 07Fh), 0 como una salida
    BSF TRISA, 2 ;ponemos puerto ((PORTA) and 07Fh), 2 y ((PORTA) and 07Fh), 3 del PORTA como una entrada
    BSF TRISA, 3

    BSF TRISE, 0 ;ponemos el puerto ((PORTE) and 07Fh), 0 y ((PORTE) and 07Fh), 1 como entrada
    BSF TRISE, 1
    ...
    BCF PORTA,0 ;ponemos el ((PORTA) and 07Fh), 0 en 0
;-----------Main-----------------
...
presionar_suma:
    btfss PORTE, 2 ;revisamos que el puerto ((PORTE) and 07Fh), 2 este presionado
    return
